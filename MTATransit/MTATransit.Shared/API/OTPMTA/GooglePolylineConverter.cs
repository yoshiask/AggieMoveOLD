...
namespace MTATransit.Shared.API.OTPMTA
{
    ...
    public static class GooglePolylineConverter
    {
        ...
        public static IEnumerable<ArcGIS.Location> Decode(string polylineString)
        {
            ...
            while (index < polylineChars.Length)
            {
                ...
                yield return new ArcGIS.Location
                {
        ...
        public static string Encode(IEnumerable<ArcGIS.Location> locations)
        {
